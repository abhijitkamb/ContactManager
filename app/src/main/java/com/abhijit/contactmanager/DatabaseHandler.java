...
/**
 * Created by Abhijit on 9/16/2015.
 */
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    public Contact getContact(int id){
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] {KEY_ID, KEY_NAME, KEY_PHONE, KEY_ADDRESS, KEY_IMAGEURI }, KEY_ID + "=?", new String[] { String.valueOf(id)}, null, null, null, null);
